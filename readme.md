...
Users will be able to create new dive logs, edit and delete.</br>
View User account, this view will show a list of dives, titles will be the date of the dive, it will have a cumulative dive counter and a cumulative duration.</br>
Will have a sort feature that allows a sort by visibility, type of water (fresh/salt), type of dive (beach, boat), scale 1-5 of how many fish.</br>
...
How to put the map in the application. I'm going to have to dig deeper into CSS to make this form appealing to the eye because I will have so many user inputs. I will need to learn how to use Heroku and publish a website.
